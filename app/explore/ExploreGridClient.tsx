...
export default function ExploreGridClient({ deals }: { deals: DealRow[] }) {
  ...
  useEffect(() => {
    ...
    es.addEventListener("error", () => {
      // If SSE fails (proxy/Vercel edge), we still have the POST endpoint.
      // We’ll just do a one-time fetch so UI doesn’t break.
      fallbackFetchOnce();
    });
