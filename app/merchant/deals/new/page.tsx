    ...
    <main className="mx-auto flex max-w-4xl flex-col gap-6 px-4 py-10">
      <header className="mb-2">
        ...
        <p className="mt-1 text-sm text-slate-500">
          Fill in the details of your promotion. Add a clear photo so customers
      ...
      >
        ...
        <div className="grid gap-4 md:grid-cols-[minmax(0,2fr)_minmax(0,1.5fr)]">
          ...
          {/* Optional image URL field (fallback / advanced) */}
          <div className="space-y-1">
            <label
              htmlFor="imageUrl"
              className="text-sm font-medium text-slate-900"
            ...
            <p className="text-[11px] text-slate-500">
              Most merchants will just upload from their phone. This field is
              only for special cases where you already have an image URL.
            </p>
          </div>
        </div>
